...
texinfo_documents = [
    ('index', 'kaggle_titanic', u'kaggle_titanic Documentation',
     u"Stephen Pettinato", 'kaggle_titanic',
     'A run through of the Kaggle Titanic model as per https://www.kaggle.com/c/titanic', 'Miscellaneous'),
]
